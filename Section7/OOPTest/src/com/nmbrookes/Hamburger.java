...
public class Hamburger {
    ...
    public Hamburger(String burgerName, String breadRoll, String meat, double price) {
    ...
    public double itemizeHamburger() {
        ...
        System.out.println(this.burgerName + " hamburger on a " + this.breadRoll + " roll" + " with " + this.meat +
                " price is " + this.price);
